...
from lucifer import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GBAN
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    try:
        bot.send_message(user_id, "You've been globally banned from all groups where I am admin. If this is a mistake, you can appeal your ban @lucifertm or PM @zerotwopmbot",parse_mode=ParseMode.HTML)
    except:
